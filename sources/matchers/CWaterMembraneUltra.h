...
#ifndef NYM_PROJECT_CWATERMEMBRANEULTRA_H
#define NYM_PROJECT_CWATERMEMBRANEULTRA_H

#include "../equip-match/equip_match_handler.h"

class CWaterMembraneUltra : public IEquipMatchHandler
{
public:
...
#endif //NYM_PROJECT_CWATERMEMBRANEULTRA_H
