...
#ifndef NYM_PROJECT_CWATERACCOUNTNODE_H
#define NYM_PROJECT_CWATERACCOUNTNODE_H

#include "../equip-match/equip_match_handler.h"

class CWaterAccountNode : public IEquipMatchHandler
{
public:
...
#endif //NYM_PROJECT_CWATERACCOUNTNODE_H
