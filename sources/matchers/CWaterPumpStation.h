...
#ifndef NYM_PROJECT_CWATERPUMPSTATION_H
#define NYM_PROJECT_CWATERPUMPSTATION_H

#include "../equip-match/equip_match_handler.h"

class CWaterPumpStation  : public IEquipMatchHandler
{
public:
...
#endif //NYM_PROJECT_CWATERPUMPSTATION_H
