...
#ifndef NYM_PROJECT_CWATERMEMBRANENANO_H
#define NYM_PROJECT_CWATERMEMBRANENANO_H

#include "../equip-match/equip_match_handler.h"

class CWaterMembraneNano : public IEquipMatchHandler
{
public:
...
#endif //NYM_PROJECT_CWATERMEMBRANENANO_H
