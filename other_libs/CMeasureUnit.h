...
public:
    ...
    CMeasureUnit(const float & value, CMeasureSet *measure, const V_SUBSTANCE & substance);
    ...
    [[nodiscard]] EChemicalElement  chemicalElement() const;
    [[nodiscard]] EGeneralizedSubstance generalized_substance() const;
    [[nodiscard]] const V_SUBSTANCE & substance() const;
    void    set_substance(EChemicalElement chemicalElement);
    void    set_substance(EGeneralizedSubstance generalizedSubstance);
    void    set_substance(const Tstring & string);
